...
scumi count_umi --bam $bam --molecular_info_h5 $molecular_info_h5 --cell_barcode_count $cell_barcode_count --gtf $gtf --expect_cell $numCells --force_cell --cell_barcode_whitelist $possible_barcodes
