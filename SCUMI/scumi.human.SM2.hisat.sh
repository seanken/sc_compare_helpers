...
fastq1=$(awk "NR==$SGE_TASK_ID" $SEEDFILE | awk '{print $2}')
fastq2=$(awk "NR==$SGE_TASK_ID" $SEEDFILE | awk '{print $3}')
#method=$(awk "NR==$SGE_TASK_ID" $SEEDFILE | awk '{print $3}')
name=$(awk "NR==$SGE_TASK_ID" $SEEDFILE | awk '{print $1}')
#numCells=$(awk "NR==$SGE_TASK_ID" $SEEDFILE | awk '{print $5}')
#ratio=$(awk "NR==$SGE_TASK_ID" $SEEDFILE | awk '{print $4}')
