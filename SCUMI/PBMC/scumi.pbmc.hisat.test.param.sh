...
#$ -l os=RedHat6
#$ -t 1-4
#$ -e ErrFile/err.cel.err
#$ -o ErrFile/out.cel.log
...
hisat2 -x $ref -U $fastq_out -k 999 --secondary --seed 12345 -S $outdir/alignment.sam
...
echo Count!
date
scumi count_umi --bam $bam".featureCounts.bam" --molecular_info_h5 $molecular_info_h5 --cell_barcode_count $cell_barcode_count --gtf $gtf --expect_cell $numCells --force_cell --cell_barcode_whitelist $possible_barcodes 
