...
#$ -cwd
#$ -e ErrFile/error.jlevin2.err
#$ -o ErrFile/out.jlevin2.log
#$ -q broad
#$ -P regevlab
#$ -l h_vmem=90g
#$ -l h_rt=140:00:00
...
samples=pbmc1_samples_files/samples.pbmc1.combined.txt
SEEDFILE=$samples
...
echo Count!
scumi count_umi --bam $bam".featureCounts.bam" --molecular_info_h5 $molecular_info_h5 --cell_barcode_count $cell_barcode_count --gtf $gtf --expect_cell $numCells --force-cell $possible_barcodes 
